...
public class UrlServiceTest {
    ...
    void shortenUrl_shouldReturnValidUrlByHashingEngine_WhenSuccessful() {
        ...
        Url urlToTest = urlService.shortenUrl(UrlPostRequestBodyCreator.createValidGithubUrlPostRequestBody().getUrl(), "", EngineType.HASHING);
    ...
    void shortenUrl_shouldReturnUrlCreatedByHashingEngine_WhenUrlAlreadyExists() {
        ...
        Url urlToTest = urlService.shortenUrl(expectedUrl.getUrl(), "", EngineType.HASHING);
    ...
    void shortenUrl_shouldReturnUrlWithAnotherShortUrl_WhenShortUrlAlreadyExists(){
        ...
        Url urlToTest = urlService.shortenUrl(alreadyExistingtUrl.getUrl(), "", EngineType.HASHING);
    ...
    void shortenUrl_throwsRecaptchaValidationException_WhenRecaptchaTokenIsNull() {
        ...
        // Assertions
        Assertions.assertThatThrownBy(() -> urlService.shortenUrl(expectedUrl.getUrl(), null, EngineType.HASHING))
                .isInstanceOf(RecaptchaValidationException.class);
    }
    ...
    void shortenUrl_throwsRecaptchaValidationException_WhenRecaptchaTokenIsInvalid() {
        ...
        // Assertions
        Assertions.assertThatThrownBy(() -> urlService.shortenUrl(expectedUrl.getUrl(), "invalid", EngineType.HASHING))
                .isInstanceOf(RecaptchaValidationException.class);
    }
